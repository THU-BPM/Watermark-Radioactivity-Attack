...
def process_batch(process_id: int, time_stamp: int, prompts: List[str], args):
    ...
    watermark = AutoWatermark.load('ReverseWatermark',
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Parallel text generation with reverse watermark')
    ...
    parser.add_argument('--reverse_watermark_config', type=str, default='config/ReverseWatermark.json')
